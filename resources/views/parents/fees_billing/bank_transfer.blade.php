@extends('layouts.app')
@section('PageTitle', 'Pay via Bank Transfer')
@section('content')
        ...
        <div class="card card-action mb-4">
          <div class="card-header align-items-center">
            ...
            <div class="card-action-element">
              ...
              >
                <i class="ti ti-speaker ti-xs me-1"></i>Notify School
              </button>
            </div>
          </div>
          <div class="card-body">
                ...
                <div class="d-flex justify-content-between flex-sm-row flex-column">
                  <div class="card-information">
                    <img
                      ...
                      alt="Master Card"
                    />
                    <h6 class="mb-2 pt-1">{{ $account->number }}</h6>
                    <span class="card-number">{{ $account->name }}</span
                    >
                  </div>
                </div>
              </div>
