<div class="modal fade" id="addNewModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered1 modal-simple">
            ...
            <div class="modal-body">
                ...
                <form id="addNewForm" class="row g-3">
                    ...
                    <div class="add_item">
                        ...
                        <div class="row  mb-2">
                            <div class="col-md-5">
                                <input type="text" name="name[]" class="form-control mb-3" placeholder="Enter Class Name" required/>
                            </div>
                            <div class="col-md-5">
                                <select class="form-select mb-3" name="form_master_id[]" required>
