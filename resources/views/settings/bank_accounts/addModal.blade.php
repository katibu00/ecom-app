        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <div class="text-center mb-3">
                    <h3 class="mb-2">Add New Bank Account</h3>
                </div>
                ...
                <form id="addNewForm" class="row g-3">
                    ...
                    <div class="add_item">
                        <div class="row  mb-2">
                            <div class="col-lg-3">
                                <input type="text" class="form-control mb-2" name="bank[]"  placeholder="Bank Name" required>
                            </div>
                            <div class="col-lg-4">
                                <input type="text" class="form-control mb-2" name="name[]"  placeholder="Account Name" required>
                            </div>
                            <div class="col-lg-3">
                                <input type="text" class="form-control mb-2" name="number[]"  placeholder="Account Number" required>
                            </div>
                            <div class="col-md-2">
