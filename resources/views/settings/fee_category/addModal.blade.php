    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add a New Fee Category(s)</h5>
                        ...
                        <div class="add_item">
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-2 row">
                                        <div class="col-lg-5">
                                            <input type="text" class="form-control m-2" name="name[]"  placeholder="Fee Category Name" required>
                                        </div>
                                        <div class="col-lg-4">
                                            <select class="default-select form-control wide mb-3" name="priority[]">
