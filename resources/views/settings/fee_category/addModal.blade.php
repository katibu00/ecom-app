            ...
            <div class="modal-body">
                ...
                <form id="addNewForm" class="row g-3">
                    ...
                    <div class="add_item">
                        <div class="row  mb-2">
                            <div class="col-lg-5">
                                <input type="text" class="form-control mb-2" name="name[]"  placeholder="Fee Category Name" required>
                            </div>
                            <div class="col-lg-4">
                                <select class="default-select form-control mb-3" name="priority[]" required>
