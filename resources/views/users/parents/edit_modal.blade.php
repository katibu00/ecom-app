    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit_parent_modal_title">Loading . . .</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal">
                </button>
            </div>
            <form id="edit_parent_form" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-12">
                                <div class="profile-img-edit">
                                    <img class="profile-pic" id="edit_parent_picture" width="150" height="150" src="/uploads/default.png" alt="parent picture">
                                    <div class="p-image">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="edit_parent_btn" class="btn btn-primary">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
