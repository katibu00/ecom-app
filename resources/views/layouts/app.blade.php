        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<img @if($school->logo == 'default.jpg') src="/uploads/no-image.jpg" @else src="/uploads/{{ $school->username }}/{{ $school->logo }}" @endif width="60" alt="school logo" class="cover-photo rounded"/>
				{{-- <h2>DemoSchool</h2> --}}
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="dlab_W_Notification1" class="widget-media dlab-scroll p-3" style="height:80px;">
										<ul class="timeline">
											{{-- <li>
